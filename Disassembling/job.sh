...
do
	...
	./Simp ../data/pc/voxels_seg_$i.pcd 0.02f ../data/mesh_simp/voxels_seg_$i.vtk ../data/mesh_simp/voxels_seg_$i.obj ../data/pc_simp/voxels_seg_$i.pcd 1 3
...
do
	...
	then
	        mv ../data/pc/done/voxels_seg_$i.pcd ../data/pc/voxels_seg_$i.pcd 
		./Simp ../data/pc/voxels_seg_$i.pcd 0.008f ../data/mesh_simp/voxels_seg_$i.vtk ../data/mesh_simp/voxels_seg_$i.obj ../data/pc_simp/voxels_seg_$i.pcd 1 3
        	mv ../data/pc/voxels_seg_$i.pcd ../data/pc/done/voxels_seg_$i.pcd
	fi
done
